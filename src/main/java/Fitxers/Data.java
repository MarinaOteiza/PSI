...
public class Data {
    ...
    public Data(int numD) {
        int i= 2;
        String s= Integer.toString (numD);
        this.dia=Integer.parseInt(s.substring(0, i));
        this.mes=Integer.parseInt(s.substring(i, i+2));
        this.any=Integer.parseInt(s.substring(i+2,i+6 ));
    }
